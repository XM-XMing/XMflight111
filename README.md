...
主场景 `Forest.unity` 中实例化 2500 棵树。每棵树包含 MeshRenderer 和 MeshCollider。
...
| 场景规模 | 森林场景含 2500 个树木实例和 2500 个 MeshCollider |
